...
class Firefly:
    ...
    def reset(self):
        ...
        self.life = random.uniform(30.0, 60.0)  # Initial life duration, between 30 and 60 seconds
        self.age = 0.0  # Age of the firefly
        self.phase_offset = random.uniform(0, 2 * math.pi)  # Random phase offset for independence
